...
exports.sendWelcomeEmail = (savedUser) => {
  ...
  const mailOptions = {
    from: `"GKAI Team" <process.env.EMAIL_USER>`,
    to: savedUser.email,
    subject: "Welcome to GKAI!",
    html: `
    <html>
      <head>
        <style>
      ...
      <body>
         <div class="email-container">
          <div class="header">
            <h1>GKAI</h1>
            <h5>Getting Killed And Injured</h5>
          </div>
          <div class="content">
            <h3>Hello, ${getFirstWord(savedUser.name)}</h3>
            <h1>Welcome to GKAI!</h1>
            <p>Thank you for joining us. We're excited to have you on board!</p>
            <p>Are you ready to elevated your reasoning? Jump to our app and get started and play to be the leader and grow in ranks.</p>
            <p>Best Regards,</p>
            <p>The GKAI Team</p>
          </div>
          <div class="footer">
            <p>&copy; ${moment().year()} GKAI. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
